...
def mktrain(
    mkmodel, mkenv, sample_fn, train_steps=10000, n_eval_eps=50, steps_btwn_evals=None
):
    ...
    def train(trial: optuna.Trial):
        ...
        eval_callback = TrialEvalCallback(
            eval_envs, trial, n_eval_eps, steps_btwn_evals
        )
...
def run_trials(
    ...
    try:
        study.optimize(
            mktrain(
                mkmodel, mkenv, sample_fn, train_steps, steps_btwn_evals=eval_period
            ),

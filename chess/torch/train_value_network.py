...
def train_value_network(value_network, train_positions, train_targets, 
                       val_positions=None, val_targets=None, 
...
def train_and_test_value_network():
    ...
    train_losses, val_losses = train_value_network(
        value_network, train_positions, train_targets,
        val_positions, val_targets,
